...
public class Interfaz extends javax.swing.JFrame {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(menu2, javax.swing.GroupLayout.PREFERRED_SIZE, 244, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {
        ...
        String defaultText2 = "<strong>Unidades de tamaño de datos soportadas: </strong><br><br>"
            + "- Bit (b)       |||| - Kilobit (Kb)<br>"
            + "- Megabit (Mb)  |||| - Gigabit (Gb)<br>"
            + "- Terabit (Tb)  |||| - Petabit (Pb)<br>"
            + "- Exabit (Eb)   |||| - Zettabit (Zb)<br>"
            + "- Yottabit (Yb) |||| - Kibibit (Kib)<br>"
            + "- Mebibit (Mib) |||| - Gibibit (Gib)<br>"
            + "- Tebibit (Tib) |||| - Kilobyte (KB)<br>"
            + "- Megabyte (MB) |||| - Gigabyte (GB)<br>"
            + "- Terabyte (TB) |||| - Petabyte (PB)<br>"
            + "- Exabyte (EB)  |||| - Zettabyte (ZB)<br>"
            + "- Yottabyte (YB)|||| - Pebibyte (PiB)<br>";
